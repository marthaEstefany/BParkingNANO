...
electronBParkTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
 ...
 cut = cms.string(""),
    ...
    variables = cms.PSet(P4Vars,
        px = Var("px()",float,doc="x part of muon momentum, in GeV",precision=6),
        py = Var("py()",float,doc="y part of muon momentum, in GeV",precision=6),
        pz = Var("pz()",float,doc="z part of muon momentum, in GeV",precision=6),
...
#        lostHits = Var("gsfTrack.hitPattern.numberOfLostHits('MISSING_INNER_HITS')","uint8",doc="number of missing inner hits"),
        ...
        pfRelIso_custom = Var("1/pt * max(pfIsolationVariables().sumChargedHadronPt + pfIsolationVariables().sumPUPt + pfIsolationVariables().sumNeutralHadronEt + pfIsolationVariables().sumPhotonEt - pfIsolationVariables().sumPUPt*0.503,0.0)",float,doc="custom PF relative isolation , total (deltaBeta corrections)"),
